    ...
    if item≥204 and item<5965
        ...
        if price=0
            case size="a" or size="A"
                ...
                sdsnumb=replace(lookup("44seeds prices","Item",item,"szA",0,0)," seeds","sds")
            case size="b" or size="B"
                price=lookup("44seeds prices","Item",item,"priceB",0,0)
                sdsnumb=replace(lookup("44seeds prices","Item",item,"szB",0,0)," seeds","sds")
            case size="c" or size="C"
                price=lookup("44seeds prices","Item",item,"priceC",0,0)                
                sdsnumb=replace(lookup("44seeds prices","Item",item,"szC",0,0)," seeds","sds")
            case size="d" or size="D"
                price=lookup("44seeds prices","Item",item,"priceD",0,0)
                sdsnumb=replace(lookup("44seeds prices","Item",item,"szD",0,0)," seeds","sds")
            case size="e" or size="E"
                price=lookup("44seeds prices","Item",item,"priceE",0,0)
                sdsnumb=replace(lookup("44seeds prices","Item",item,"szE",0,0)," seeds","sds")
            case size="k" or size="K"
                price=lookup("44seeds prices","Item",item,"priceK",0,0)
                sdsnumb=replace(lookup("44seeds prices","Item",item,"szK",0,0)," seeds","sds")
            case size="l" or size="L"
                price=lookup("44seeds prices","Item",item,"priceL",0,0)
                sdsnumb=replace(lookup("44seeds prices","Item",item,"szL",0,0)," seeds","sds")
            endcase
        endif
        if Staff="Y"
...
˛/.fbfindˇ˛.fbLiveQueryˇcase val(fbliveQuery) > 0
    liveclairvoyance fbliveQuery, fbqueryResults, ¶, "FB Query List", "44bulbs lookup", str(number), "", 
    arraysort(
...
˛/find customers without c#ˇ˛.temp_lunarˇlocal Dictionary, ProcedureList
...
message ProcedureList //messages which procedures got changed˛/.temp_lunarˇ